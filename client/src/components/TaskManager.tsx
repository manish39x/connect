...
const TaskManager = () => {
  ...
  return (
    <div className=" w-full h-full flex flex-col  gap-[10px] items-center px-[15px] py-[12px]">
      <h3 className="text-[28px] font-extrabold font-primary">
        <span className="text-unique font-extrabold">T</span>ASKS
      </h3>
      <div className="search-task w-full flex items-center gap-[10px]">
        <div className="rounded-[5px] w-full overflow-hidden bg-white flex flex-1 justify-between items-center px-[1rem]">
          <input type="text" value={searchInput} autoComplete='false' name='searchBox' className=" text-black py-[.4rem] w-[80%] text-[13px] md:text-[14px] outline-none border-none" placeholder="search for tasks" onChange={(e) => setSearchInput(e.target.value)} /> 
        ...
        <div className="filter bg-[#5a5a5c] text-white h-full aspect-square flex-center rounded-[5px] ">
