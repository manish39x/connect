...
const Register = () => {
  ...
  return (
    <div className="w-full px-[35px] flex flex-col gap-[30px] justify-center items-center">
      <h2 className="text-[24px] text-primary font-bold">Wellcome <span className="text-unique">B</span>uddy!</h2>
      <div className="inputs w-full flex flex-col  gap-[10px]">
        <div className="input flex flex-col gpa-[8px] w-full">
          ...
          <input type="text" placeholder='"foxy54"' className={` border-none outline-none rounded-[5px] py-[6px] px-[10px] text-[15px] bg-white text-black`} onChange={(e) => setEmail(e.target.value) } />
        </div>
        <div className="input flex flex-col gpa-[8px] w-full">
      ...
      <button className="w-full rounded-[5px] bg-unique text-black text-[16px] font-bold text-primary py-[8px] cursor-pointer">
        Register
      </button>
    </div>
  )
